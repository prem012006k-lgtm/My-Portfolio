...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* Confirms script.js actually loaded and ran. The fade-in
     animation in style.css only applies once this class is
     present, so if this file ever fails to load, the page
     content still shows normally (just without the animation)
  ...
  /* -------------------------------------------------------
     SCROLL REVEAL
     Fades/slides elements with class "reveal" into view
  ...
  /* -------------------------------------------------------
     TYPEWRITER TAGLINE
     Cycles through a short list of phrases in the hero.
     Edit the PHRASES array below to change what it says.
     ------------------------------------------------------- */
  ...
  if (typingEl && !prefersReducedMotion) {
    ...
    // start from a full first phrase, already displayed in HTML,
